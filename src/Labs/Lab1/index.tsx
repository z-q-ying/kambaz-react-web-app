        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Brew 1 shot of espresso.</li>
                    <li>Steam 1 cup of milk until frothy.</li>
                    <li>Pour the steamed milk over the espresso.</li>
                    <li>Top with milk foam.</li>
            ...
            <div id="wd-images">
                ...
                <br />
                <img id="wd-teslabot" src="images/teslabot.jpg" height="200px" alt="Tesla Bot humanoid robot concept" />
            </div>
            <div id="wd-forms">
                <h4>Form Elements</h4>
            ...
            <div id="wd-anchors">
                ...
                Also, check out my code on this <a href="https://github.com/z-q-ying/kanbas-react-web-app" id="wd-github">GitHub repository</a>.
            </div>
        </div>
    );
}