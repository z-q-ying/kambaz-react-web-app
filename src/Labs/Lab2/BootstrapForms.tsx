...
export default function BootstrapForms() {
    return (
        <div>
            {/* Styling Forms with React Bootstrap */}
            ...
            {/* Styling Dropdowns with React Bootstrap */}
            ...
            {/* Styling Switches with React Bootstrap */}
            ...
            {/* Styling Range and Sliders with React Bootstrap */}
            ...
            {/* Styling Addons with React Bootstrap */}
            ...
            {/* Styling Responsive Forms with React Bootstrap */}
                ...
                <Form>
                    ...
                    <fieldset>
                        <Form.Group as={Row} className="mb-3">
                            ...
                            <Col sm={10}>
                                <Form.Check type="radio" label="first radio" defaultChecked name="formHorizontalRadios" />
                    ...
                    <Form.Group as={Row} className="mb-3">
                        <Col sm={{ span: 10, offset: 2 }}><Form.Check label="Remember me" /></Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3">
