...
import { assignments, assignmentGroups } from "../../Database";
          ...
          <ListGroup key={g._id} className="rounded-0" id="wd-modules">
            <ListGroup.Item className="wd-module p-0 mb-5 fs-5 border-gray">
              ...
              <div className="wd-title p-3 ps-2 bg-secondary d-flex justify-content-between ">
                ...
                <AssignmentControlButtons weight={g.weight} />
              </div>

              {/* Assignement Items */}
              <ListGroup className="rounded-0" id="wd-modules">
                {assignments
                  .filter((a: any) => a.assignmentGroup === g._id)
                  .map((a: any) => (
                    <ListGroup.Item
                      key={a._id}
