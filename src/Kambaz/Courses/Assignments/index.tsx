                            ...
                            <Row className="align-items-center">
                                ...
                                <Col className="px-0">
                                    <div className="d-flex flex-column text-start">
                                        <button
                                            onClick={() => navigate("/Kambaz/Courses/1234/Assignments/1")}
                        ...
                        <ListGroup.Item className="wd-assignment-list-item p-3 ps-1">
                            <Row className="align-items-center">
                                ...
                                <Col className="px-0">
                                    <div className="d-flex flex-column text-start">
                                        <button
                                            onClick={() => navigate("/Kambaz/Courses/1234/Assignments/2")}
                                            className="fw-bold text-dark border-0 bg-transparent p-0 m-0 wd-assignment-title-button"
                                            style={{ width: "100%", textAlign: "left" }}
                                        >
                                            A2 - CSS + BOOTSTRAP
                        ...
                        <ListGroup.Item className="wd-assignment-list-item p-3 ps-1">
                            <Row className="align-items-center">
                                ...
                                <Col className="px-0">
                                    <div className="d-flex flex-column text-start">
                                        <button
                                            onClick={() => navigate("/Kambaz/Courses/1234/Assignments/3")}
                                            className="fw-bold text-dark border-0 bg-transparent p-0 m-0 wd-assignment-title-button"
                                            style={{ width: "100%", textAlign: "left" }}
                                        >
                                            A3 - JAVASCRIPT + REACT
                        ...
                        <ListGroup.Item className="wd-assignment-list-item p-3 ps-1">
                            <Row className="align-items-center">
                                ...
                                <Col className="px-0">
                                    <div className="d-flex flex-column text-start">
                                        <button
                                            onClick={() => navigate("/Kambaz/Courses/1234/Assignments/4")}
                                            className="fw-bold text-dark border-0 bg-transparent p-0 m-0 wd-assignment-title-button"
                                            style={{ width: "100%", textAlign: "left" }}
                                        >
                                        ...
                                        <small className="text-muted">
                                            <span className="text-danger">Multiple Modules</span> | <b>Not available until</b> May 6 at 12:00am | <b>Due</b> June 22 at 11:59pm | 100 pts
                                        </small>
                                    </div>
                                </Col>
                                <Col xs="auto">
